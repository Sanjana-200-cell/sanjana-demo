...
class SimpleFaceDetection:
    ...
    def detect_faces_in_image(self, image_path):
        """
        Detect faces in a single image using Haar Cascades
        """
        # Read the image
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            detector.real_time_face_detection()
        
        elif choice == '2':
            image_path = input("Enter path to image file: ").strip()
            result_image = detector.detect_faces_in_image(image_path)
